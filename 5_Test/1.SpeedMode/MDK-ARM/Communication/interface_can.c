...
{
	{WRITE_ONLY , 0x01 , (uint8_t*)(&blazer_content_transform[0].u8_data)},
	{WRITE_ONLY , 0x02 , (uint8_t*)(&blazer_content_transform[1].u8_data)},
	{WRITE_ONLY , 0x03 , (uint8_t*)(&blazer_content_transform[2].u8_data)},
	{WRITE_ONLY , 0x04 , (uint8_t*)(&blazer_content_transform[3].u8_data)},
};
...
void set_blazer_speed(uint32_t node_id,float speed)
{
	...
	blazer_content_transform[node_id].u8_data[0] = speed_int >> 24;
	blazer_content_transform[node_id].u8_data[1] = speed_int >> 16;
	blazer_content_transform[node_id].u8_data[2] = speed_int >> 8;
	blazer_content_transform[node_id].u8_data[3] = speed_int;
